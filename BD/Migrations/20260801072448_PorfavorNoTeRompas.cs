...
{
    /// <inheritdoc />
    public partial class PorfavorNoTeRompas : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attendances_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "13e4d876-05dc-4467-81f0-65d547e7216e", "3", "Preceptor_Auxiliar", "PRECEPTOR_AUXILIAR" },
                    { "5d0d8ba9-8c14-4301-bb17-83a6cd5e3636", "2", "Preceptor", "PRECEPTOR" },
                    { "69586e48-deb9-4f7f-8261-8639e8c02ece", "5", "Estudiante", "ESTUDIANTE" },
                    { "f1a9f563-0440-4315-9334-09ca95dbbac5", "4", "Docente", "DOCENTE" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ae65a54a-aab5-4d0c-aa17-554334b49e8c", 0, "aa61395f-5053-49a3-8bd3-4ee205716e82", "", true, false, null, "", "SUPERADMINISPT-2026", "AQAAAAIAAYagAAAAEG3J+nMiY4jkRZDU+naHSl0aPJMMvFhmCAX0NDCNmZsQHq2jH7IjCTF1hTYsGgYVmA==", null, false, "e83242f8-b566-4b40-a853-ff7825cae099", false, "SuperadminISPT-2026" });
