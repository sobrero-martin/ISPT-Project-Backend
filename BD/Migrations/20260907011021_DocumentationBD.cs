...
{
    /// <inheritdoc />
    public partial class DocumentationBD : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Degrees_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Files_People_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileCurriculum", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FileCurriculum_Curriculums_CurriculumId",
                        column: x => x.CurriculumId,
                        principalTable: "Curriculums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FileCurriculum_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TemplateState = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    state = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DivisionTemplates_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Divisions_DivisionTemplates_DivisionTemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherDivisions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherDivisions_DivisionTemplates_DivisionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceDays_Divisions_DivisionId",
                        column: x => x.DivisionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FileCurriculumId = table.Column<long>(type: "bigint", nullable: false),
                    DivisionId = table.Column<long>(type: "bigint", nullable: false),
                    FileDivisionStatus = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FileDivisions_FileCurriculum_FileCurriculumId",
                        column: x => x.FileCurriculumId,
                        principalTable: "FileCurriculum",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FileDivisionId = table.Column<long>(type: "bigint", nullable: false),
                    AttendanceDayId = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    state = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_AttendanceDays_AttendanceDayId",
                        column: x => x.AttendanceDayId,
                        principalTable: "AttendanceDays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attendances_FileDivisions_FileDivisionId",
                        column: x => x.FileDivisionId,
                        principalTable: "FileDivisions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinalExamGrades_FileDivisions_FileDivisionId",
                        column: x => x.FileDivisionId,
                        principalTable: "FileDivisions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FileDivisionId = table.Column<long>(type: "bigint", nullable: false),
                    DivisionExamId = table.Column<long>(type: "bigint", nullable: false),
                    GradeNumber = table.Column<short>(type: "smallint", nullable: false),
                    state = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_DivisionExams_DivisionExamId",
                        column: x => x.DivisionExamId,
                        principalTable: "DivisionExams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Grades_FileDivisions_FileDivisionId",
                        column: x => x.FileDivisionId,
                        principalTable: "FileDivisions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "30f27d0d-2fba-497c-aa61-90742a9aaf72", "5", "Estudiante", "ESTUDIANTE" },
                    { "3f8e8a40-0c78-4bea-8d7d-1d39d823c661", "2", "Preceptor", "PRECEPTOR" },
                    { "5a65968a-1abc-4981-bee0-7828a2cdc7f5", "3", "Preceptor_Auxiliar", "PRECEPTOR_AUXILIAR" },
                    { "e1f4ba94-b1c1-4905-b76d-a629cdb9f2c3", "4", "Docente", "DOCENTE" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ae65a54a-aab5-4d0c-aa17-554334b49e8c", 0, "1f14a794-912b-4d7d-91b8-98e83e6a296e", "", true, false, null, "", "SUPERADMINISPT-2026", "AQAAAAIAAYagAAAAEMh0n8n3Hu2L1KTLiIoODY+zV7IQo/lYRS2puaN8UbyjLyhEgibdqB6Zzz3DmzTZgQ==", null, false, "e825eba8-129a-4959-9612-08599fb6d7bb", false, "SuperadminISPT-2026" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "rol-directivo-id", "ae65a54a-aab5-4d0c-aa17-554334b49e8c" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceDays_DivisionId",
                table: "AttendanceDays",
                column: "DivisionId");

            migrationBuilder.CreateIndex(
                name: "IX_Attendances_AttendanceDayId",
                table: "Attendances",
                column: "AttendanceDayId");

            migrationBuilder.CreateIndex(
                name: "IX_Attendances_FileDivisionId",
                table: "Attendances",
                column: "FileDivisionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Divisions_DivisionTemplateId",
                table: "Divisions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DivisionTemplates_SubjectId",
                table: "DivisionTemplates",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Documentations_FileId_Date",
                table: "Documentations",
                columns: new[] { "FileId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FileCurriculum_CurriculumId",
                table: "FileCurriculum",
                column: "CurriculumId");

            migrationBuilder.CreateIndex(
                name: "IX_FileCurriculum_FileId_CurriculumId",
                table: "FileCurriculum",
                columns: new[] { "FileId", "CurriculumId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinalExamGrades_FileDivisionId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Grades",
                column: "DivisionExamId");

            migrationBuilder.CreateIndex(
                name: "IX_Grades_FileDivisionId",
                table: "Grades",
                column: "FileDivisionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherDivisions_TeacherId",
                table: "TeacherDivisions",
                column: "TeacherId");
        }
